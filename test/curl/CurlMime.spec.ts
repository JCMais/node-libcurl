...
describe.runIf(Curl.isVersionGreaterOrEqualThan(7, 56, 0))('CurlMime', () => {
  ...
  it('should handle mixed text fields and file uploads', async () => {
    ...
    filePart.setFiledata(imageFilePath)
    filePart.setType('image/png')
  ...
  describe('Data Callbacks', () => {
    ...
    it('should handle read callback with free', async () => {
      ...
      // Note: The free callback may be called during cleanup, which happens asynchronously
      // For this test, we're mainly verifying that providing a free callback doesn't cause errors
    })
