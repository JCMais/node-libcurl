...
class NodeCurl
{
	...
	void on_end(CURLMsg *msg)
	{
		...
		if (cb->IsFunction())
		{
			cb->ToObject()->CallAsFunction(handle, 0, NULL);
		}
	}
	...
	static v8::Handle<v8::Value> Initialize(v8::Handle<v8::Object> target)
	{
		...
		// Set curl constants
		#include "generated-stubs/string_options.h"
		#include "generated-stubs/integer_options.h"
		#include "generated-stubs/string_infos.h"
		#include "generated-stubs/integer_infos.h"
		#include "generated-stubs/double_infos.h"
